...
function mousePressed(){
    hanmer=true
    if(change==false&&750<=mouseX&&1150>=mouseX&&700<=mouseY&&820>=mouseY){
    retry=true;
    FCC=0
}
if(change==false&&750<=mouseX&&1150>=mouseX&&550<=mouseY&&670>=mouseY){
    N+=1;
    point[N]=0;
    time=60;
    home=true;
...
if(change==true&&home==true&&1390<=mouseX&&1805>=mouseX&&700<=mouseY&&820>=mouseY){
    hanmer=false
    N+=1;
    point[N]=0;
    spoint=[0,0,0,0];
...
if(change==true&&home==false&&a==true){
    ...
    if(a==true&&((abs(normal.x-mouseX+50)<95&&abs(normal.y-mouseY-45)<110)||(abs(normal.x-mouseX)<75&&abs(normal.y-mouseY)<75))){
        point[N]+=1
        normal.move();
        spoint[0]+=1
        njudge=true;
    }
    if(a==true&&((abs(normal2.x-mouseX+50)<95&&abs(normal2.y-mouseY-45)<110)||(abs(normal2.x-mouseX)<75&&abs(normal2.y-mouseY)<75))){
        point[N]+=1
        normal2.move();
        spoint[0]+=1
        njudge=true;
    }
    if(a==true&&((abs(special.x-mouseX+50)<95&&abs(special.y-mouseY-45)<110)||(abs(special.x-mouseX)<75&&abs(special.y-mouseY)<75))){
        point[N]+=2
        special.x=random(cr);
        special.y=random(cri);
        spoint[1]+=1
    ...
    if(a==true&&((abs(rainbow.x-mouseX+50)<95&&abs(rainbow.y-mouseY-45)<110)||(abs(rainbow.x-mouseX)<75&&abs(rainbow.y-mouseY)<75))){
        point[N]+=5
        rainbow.x=random(cr);
    ...
    if(a==true&&((abs(damage.x-mouseX+50)<95&&abs(damage.y-mouseY-45)<110)||(abs(damage.x-mouseX)<75&&abs(damage.y-mouseY)<75))){
        point[N]-=3
        damage.x=random(cr);
        damage.y=random(cri);
        spoint[3]-=1
  ...
  fill("#55585f");
  rect(mouseX-35,mouseY-10,70,30);}
  if(hanmer==true){
      FCB+=1
    fill("#bba828");
    rect(mouseX-35,mouseY+35,100,20);
    fill("#55585f");
    rect(mouseX-65,mouseY+10,30,70);
    if(FCB%7<=0){hanmer=false}
  }
  fill("#FFFFCF");
if(njudge==true){
    FCE+=1;
    text("+1",mouseX+50,mouseY-50);
    if(FCE%30<=0){
        njudge=false;
        FCE=0;
    }}
